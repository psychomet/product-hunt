...
export type GetProductQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, slug: string, description: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string }, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: any, currencyCode: CurrencyCode, priceWithTax: any, sku: string, stockLevel: string }> } };
...
export type SharedDataAccessLoginMutation = { __typename?: 'Mutation', login: { __typename: 'CurrentUser', id: string, identifier: string } | { __typename: 'InvalidCredentialsError', errorCode: ErrorCode, message: string } | { __typename: 'NativeAuthStrategyError', errorCode: ErrorCode, message: string } | { __typename: 'NotVerifiedError', errorCode: ErrorCode, message: string } };
...
export type SharedDataAccessVerifyMutation = { __typename?: 'Mutation', verifyCustomerAccount: { __typename: 'CurrentUser', id: string, identifier: string } | { __typename: 'MissingPasswordError', errorCode: ErrorCode, message: string } | { __typename: 'NativeAuthStrategyError', errorCode: ErrorCode, message: string } | { __typename: 'PasswordAlreadySetError', errorCode: ErrorCode, message: string } | { __typename: 'PasswordValidationError', errorCode: ErrorCode, message: string } | { __typename: 'VerificationTokenExpiredError', errorCode: ErrorCode, message: string } | { __typename: 'VerificationTokenInvalidError', errorCode: ErrorCode, message: string } };
...
export type UserFragment = { __typename?: 'CurrentUser', id: string, identifier: string, channels: Array<{ __typename?: 'CurrentUserChannel', id: string, token: string, code: string, permissions: Array<Permission> }> };
...
export type GetFeaturedProductsQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', items: Array<{ __typename?: 'SearchResult', productId: string, productName: string, slug: string, description: string, currencyCode: CurrencyCode, inStock: boolean, productAsset?: { __typename?: 'SearchResultAsset', preview: string, focalPoint?: { __typename?: 'Coordinate', x: number, y: number } }, price: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any }, priceWithTax: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any } }> } };

export type ShellLayoutSignOutMutationVariables = Exact<{ [key: string]: never; }>;


export type ShellLayoutSignOutMutation = { __typename?: 'Mutation', logout: { __typename?: 'Success', success: boolean } };
